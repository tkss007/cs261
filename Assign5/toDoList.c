...
{
    if (((TaskP)left)->priority > ((TaskP)right)->priority)
        return 1;
    else if (((TaskP)left)->priority < ((TaskP)right)->priority)
        return -1;
    else if (((TaskP)left)->priority == ((TaskP)right)->priority)
    {
        if (((TaskP)left)->time > ((TaskP)right)->time) {
            return 1;
        }else if (((TaskP)left)->time < ((TaskP)right)->time)
        {
            return -1;
        }else
            return 0;
...
{
    TaskP task;
    task = (TaskP)malloc(sizeof(struct Task));
