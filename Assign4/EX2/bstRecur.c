...
//    
//    /*Create value of the type of data that you want to store*/
//    struct pizza *myPizza1 = (struct pizza *) malloc(sizeof(struct pizza));
//    struct pizza *myPizza2 = (struct pizza *) malloc(sizeof(struct pizza));
//    struct pizza *myPizza3 = (struct pizza *) malloc(sizeof(struct pizza));
//    struct pizza *myPizza4 = (struct pizza *) malloc(sizeof(struct pizza));
//    struct pizza *myPizza5 = (struct pizza *) malloc(sizeof(struct pizza));
//    
//    
//    myPizza1->cost = 6.6;
//    myPizza1->name = "PizzaOne";
//    myPizza2->cost = 7.8;
//    myPizza2->name = "PizzaTwo";
//    myPizza3->cost = 5.5;
//    myPizza3->name = "PizzaThree";
//    myPizza4->cost = 8.9;
//    myPizza4->name = "PizzaFour";
//    myPizza5->cost = 10;
//    myPizza5->name = "PizzaFive";
//    
//    addBSTree(tree, myPizza1);
//    addBSTree(tree, myPizza2);
//    addBSTree(tree, myPizza3);
//    addBSTree(tree, myPizza4);
//    
//    printTree(tree);
//    
//    printf("\n");
...
//    
//    
//    printTestResult(containsBSTree(tree, myPizza1), "containsBSTree", "when test containing PizzaOne as root");
//    
//    printTestResult(containsBSTree(tree, myPizza2), "containsBSTree", "when test containing PizzaTwo as right of root");
//    
//    printTestResult(containsBSTree(tree, myPizza3), "containsBSTree", "when test containing PizzaThree as left of root");
//    
//    printTestResult(containsBSTree(tree, myPizza4), "containsBSTree", "when test containing PizzaFour as right of right of root");
//    
//    printTestResult(!containsBSTree(tree, myPizza5), "containsBSTree", "when test containing PizzaFive, which is not in the tree");
//    
//    
//    printf("\n");
//    printf("\n");
...
//    
//    
//    printTestResult(compare(_leftMost(tree->root), myPizza3) == 0, "_leftMost", "left most of root");
//    
//    printTestResult(compare(_leftMost(tree->root->right), myPizza2) == 0, "_leftMost", "left most of right of root");
//    
//    
//    printf("\n");
//    printf("\n");
...
//    cur = _removeLeftMost(tree->root);
//    
//    printTestResult(cur == tree->root, "_removeLeftMost", "removing leftmost of root");
//    
//    
//    printTree(tree);
//    
...
//    printf("\n");
//    
//    _removeNode(tree->root, myPizza3);
//    printTestResult(compare(tree->root->val, myPizza1) == 0 && tree->root->left == NULL, "_removeNode", "remove left of root");
//    
//    _removeNode(tree->root, myPizza4);
//    printTestResult(compare(tree->root->val, myPizza1) == 0 && tree->root->right->right == 0, "_removeNode", "remove right of right of root");
//    
//    _removeNode(tree->root, myPizza2);
//    printTestResult(compare(tree->root->val, myPizza1) == 0 && tree->root->right == 0, "_removeNode", "remove right of root");
//
//
//     printTree(tree);
//    
